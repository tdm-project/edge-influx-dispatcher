...
class TestMessagesNoAuth(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.influxdb_host = os.environ['INFLUXDB_REMOTE_HOST']
        self.influxdb_port = os.environ['INFLUXDB_REMOTE_PORT']
        self.influxdb_db = os.environ['INFLUXDB_REMOTE_DB']
        self.influxdb_user = os.environ['INFLUXDB_REMOTE_USER']
        self.influxdb_pass = os.environ['INFLUXDB_REMOTE_PASS']
        ...
        self.influxdb_client.switch_user(
            self.influxdb_user, self.influxdb_pass)
